...
#         self.dilate1 = nn.Conv2d(inch, inch, kernel_size=3, dilation=1, padding=1)
...
class ASPP(nn.Module):
    def __init__(self, in_channel=512, depth=256):
        ...
        self.conv_1x1_output = Conv_block(depth * 5, depth, [1, 1])  # nn.Conv2d(depth * 5, depth, 1, 1)
    ...
    def forward(self, x):
        ...
        image_features = F.upsample(image_features, size=size, mode='bilinear', align_corners=False)
