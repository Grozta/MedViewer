...
from models.nnUNet.nnunet.inference.predict import predict_from_folder
from models.nnUNet.nnunet.paths import default_plans_identifier, network_training_output_dir, default_cascade_trainer, default_trainer
from models.nnUNet.nnunet.utilities.task_name_id_conversion import convert_id_to_task_name

"""
/home/y/nnUNetFrame/DATASET/nnUNet_raw/nnUNet_raw_data/Task001_rib/imagesTs
"""
def main():
    parser = argparse.ArgumentParser()
    # parser.add_argument("-i", '--input_folder', default='/media/y/TOSHIBA_EXT/nnUNetFrame/DATASET/nnUNet_raw/nnUNet_raw_data/Task001_rib/imagesTs/',help="Must contain all modalities for each patient in the correct"
    #                                                  " order (same as training). Files must be named "
    #                                                  "CASENAME_XXXX.nii.gz where XXXX is the modality "
    #                                                  "identifier (0000, 0001, etc)", required=True)
    parser.add_argument("-i", '--input_folder',
                        default=r'F:\nnUNetFrame/DATASET/nnUNet_raw/nnUNet_raw_data/Task001_rib/imagesTs/',
    ...
    # parser.add_argument('-o', "--output_folder",default='/media/y/TOSHIBA_EXT/nnUNetFrame/DATASET/nnUNet_raw/nnUNet_raw_data/Task001_rib/inferTs/', required=True, help="folder for saving predictions")
    parser.add_argument('-o', "--output_folder",
                        default=r'F:\nnUNetFrame/DATASET/nnUNet_raw/nnUNet_raw_data/Task001_rib/inferTs/',
                         help="folder for saving predictions") # 将requires=True去掉了

    # parser.add_argument('-t', '--task_name', help='task name or task ID, required.',
    #                     default=default_plans_identifier, required=True)
    parser.add_argument('-t', '--task_name', help='task name or task ID, required.',
                        default='001') # require=True
...
"""
output_fold:预测结果保存的路径，如果没有这个路径会新创建一个
