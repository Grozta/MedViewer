...
from models.nnUNet.nnunet.training.dataloading.dataset_loading import load_dataset, DataLoader3D, DataLoader2D, \
    unpack_dataset
from models.nnUNet.nnunet.training.loss_functions.dice_loss import DC_and_CE_loss
from models.nnUNet.nnunet.training.network_training.network_trainer import NetworkTrainer
...
from models.nnUNet.nnunet.preprocessing.preprocessing import GenericPreprocessor
...
class nnUNetTrainer(NetworkTrainer):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
        ...
        IMPORTANT: If you inherit from models.nnUNet.nnunetTrainer and the init args change then you need to redefine self.init_args
    ...
    def preprocess_patient(self, input_files):
        ...
        #     preprocessor_name,
        #     current_module="models.nnUNet.nnunet.preprocessing")
