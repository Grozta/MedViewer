...
from models.nnUNet.nnunet.experiment_planning.DatasetAnalyzer import DatasetAnalyzer
from models.nnUNet.nnunet.experiment_planning.utils import crop
from models.nnUNet.nnunet.paths import *
from models.nnUNet.nnunet.preprocessing.sanity_checks import verify_dataset_integrity
from models.nnUNet.nnunet.training.model_restore import recursive_find_python_class
from models.nnUNet.nnunet.utilities.task_name_id_conversion import convert_id_to_task_name
from models.nnUNet.nnunet.paths import nnUNet_raw_data
from models.nnUNet.nnunet.paths import nnUNet_cropped_data, preprocessing_output_dir
...
def main():
    ...
    search_in = join(base_dir, 'models', 'nnUNet', 'nnunet', "experiment_planning")

    if planner_name3d is not None:
        planner_3d = recursive_find_python_class([search_in], planner_name3d, current_module="models.nnunet.nnUNet.experiment_planning")
    ...
    if planner_name2d is not None:
        planner_2d = recursive_find_python_class([search_in], planner_name2d, current_module="models.nnUNet.nnunet.experiment_planning")
