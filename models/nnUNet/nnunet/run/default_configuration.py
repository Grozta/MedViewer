...
from models.nnUNet.nnunet.paths import network_training_output_dir, preprocessing_output_dir, default_plans_identifier
from batchgenerators.utilities.file_and_folder_operations import *
from models.nnUNet.nnunet.experiment_planning.summarize_plans import summarize_plans
...
def get_default_configuration(network, task, network_trainer, plans_identifier=default_plans_identifier,
                              search_in=(base_dir, 'models', 'nnUNet', 'nnunet', "training", "network_training"),
                              base_module='models.nnUNet.nnunet.training.network_training'):
