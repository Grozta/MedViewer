...
from models.CTPelvic1K.nnunet.experiment_planning.plan_and_preprocess_task import \
    get_caseIDs_from_splitted_dataset_folder
...
def predict_from_folder(model, input_folder, output_folder, folds, save_npz, num_threads_preprocessing,
    ...
    if lowres_segmentations is not None:
        ...
        lowres_segmentations = lowres_segmentations[
                               part_id::num_parts]  ### begin with part_id, get out one from every num_parts items
    else:
