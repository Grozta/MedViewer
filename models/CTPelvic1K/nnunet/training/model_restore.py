...
def restore_model(pkl_file, checkpoint=None, train=False):
    ...
    init = info['init']
    name = info['name'] # nnUNetTrainer
    # search_in = os.path.join(base_dir, 'models', 'CTPelvic1K', 'nnunet', "training", "network_training")
    tr = nnUNetTrainer
    # tr = recursive_find_trainer([search_in], name, current_module="models.CTPelvic1K.nnunet.training.network_training")
