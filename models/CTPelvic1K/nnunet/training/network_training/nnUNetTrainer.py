...
from models.CTPelvic1K.nnunet.training.network_training.network_trainer import NetworkTrainer
...
from models.CTPelvic1K.nnunet.training.dataloading.dataset_loading import load_dataset, DataLoader3D, DataLoader2D, unpack_dataset, \
    DataLoader3D_oversampleJoint
from models.CTPelvic1K.nnunet.training.loss_functions.dice_loss import DC_and_CE_loss, DC_and_CE_Exclusion_loss, \
...
from models.CTPelvic1K.nnunet.training.data_augmentation.default_data_augmentation import default_3D_augmentation_params, \
...
from models.CTPelvic1K.nnunet.evaluation.metrics import ConfusionMatrix
...
class nnUNetTrainer(NetworkTrainer):
    ...
    def initialize_network_optimizer_and_scheduler(self, use_hdc=False):
        ...
        if use_hdc:
            self.network = HDC_Net(1, 4, num_filters=32)
            self.network.cuda()
    ...
    def preprocess_patient(self, input_files):
        ...
        :return:
        """
        from models.CTPelvic1K.nnunet.preprocessing.preprocessing import GenericPreprocessor, PreprocessorFor2D
        if self.threeD:
