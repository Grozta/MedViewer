...
from models.CTPelvic1K_CS_Net_origin.nnunet.network_architecture.generic_UNet import Generic_UNet
from models.CTPelvic1K_CS_Net_origin.nnunet.experiment_planning.configuration import FEATUREMAP_MIN_EDGE_LENGTH_BOTTLENECK
...
def get_pool_and_conv_props_poolLateV2(patch_size, min_feature_map_size, max_numpool, spacing):
    ...
    num_pool_per_axis = get_network_numpool(patch_size, max_numpool, min_feature_map_size) # properity of network
