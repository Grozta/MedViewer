...
from models.CTPelvic1K_CS_Net_origin.nnunet.experiment_planning.find_classes_in_slice import add_classes_in_slice_info
from models.CTPelvic1K_CS_Net_origin.nnunet.preprocessing.cropping import ImageCropper
from batchgenerators.utilities.file_and_folder_operations import *
from models.CTPelvic1K_CS_Net_origin.nnunet.paths import splitted_4d_output_dir, cropped_output_dir, preprocessing_output_dir, raw_dataset_dir
import numpy as np
import pickle
from models.CTPelvic1K_CS_Net_origin.nnunet.experiment_planning.DatasetAnalyzer import DatasetAnalyzer
import os
from multiprocessing import Pool
import json
import shutil
from models.CTPelvic1K_CS_Net_origin.nnunet.experiment_planning.common_utils import split_4d_nifti
...
def plan_and_preprocess(task_string, processes_lowres=8, processes_fullres=3, no_preprocessing=False):
    from models.CTPelvic1K_CS_Net_origin.nnunet.experiment_planning.experiment_planner_baseline_2DUNet import ExperimentPlanner2D
    from models.CTPelvic1K_CS_Net_origin.nnunet.experiment_planning.experiment_planner_baseline_3DUNet import ExperimentPlanner
...
if __name__ == "__main__":
    ...
    parser.add_argument('-pl', '--processes_lowres', type=int, default=4, help='number of processes used for '
                                                                               ...
                                                                               'RAM', required=False)
    parser.add_argument('-pf', '--processes_fullres', type=int, default=2, help='number of processes used for '
