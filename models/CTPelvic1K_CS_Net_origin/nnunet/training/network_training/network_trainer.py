...
from datetime import datetime
from models.CTPelvic1K_CS_Net_origin.nnunet.training.loss_functions.ND_Crossentropy import get_converted_sdf_from_target, get_sdf_from_target
import tqdm
...
class NetworkTrainer(object):
    def __init__(self, deterministic=True, fp16=False):
        ...
        self.num_val_batches_per_epoch = 50  # 50
    ...
    def run_training(self):
        ...
        while self.epoch < self.max_num_epochs:
            ...
            # train one epoch
            self.network.train()
            for b in tqdm.tqdm(range(self.num_batches_per_epoch)):
            ...
            with torch.no_grad():
                ...
                self.network.eval()
                val_losses = []
                for b in tqdm.tqdm(range(self.num_val_batches_per_epoch)):
