...
from models.CTPelvic1K_CS_Net_origin.nnunet.training.network_training.CS_Net import cs_net
from models.CTPelvic1K_CS_Net_origin.nnunet.training.network_training.network_trainer import NetworkTrainer
...
from models.CTPelvic1K_CS_Net_origin.nnunet.training.dataloading.dataset_loading import load_dataset, DataLoader3D, DataLoader2D, unpack_dataset, DataLoader3D_oversampleJoint
from models.CTPelvic1K_CS_Net_origin.nnunet.training.loss_functions.dice_loss import DC_and_CE_loss, DC_and_CE_Exclusion_loss, DC_and_CE_Exclusion_loss_DeepS
...
from models.CTPelvic1K_CS_Net_origin.nnunet.training.data_augmentation.default_data_augmentation import default_3D_augmentation_params, \
...
from models.CTPelvic1K_CS_Net_origin.nnunet.evaluation.metrics import ConfusionMatrix
from models.CTPelvic1K_CS_Net_origin.nnunet.training.network_training.HSC82 import PGS_Net
...
class nnUNetTrainer(NetworkTrainer):
    ...
    def initialize_network_optimizer_and_scheduler(self):
        ...
        # TODO CSNET
        # self.network = PGS_Net(in_channels=self.num_input_channels, out_channels=4, device='0')
        self.network = cs_net(in_channels=self.num_input_channels, out_channels=4, num_filters=70)
    ...
    def process_plans(self, plans):
        ...
        # TODO CSNET
        self.num_input_channels = 5 if self.network_dims == '2d' else plans['num_modalities']
    ...
    def preprocess_patient(self, input_files):
        ...
        :return:
        """
        from models.CTPelvic1K_CS_Net_origin.nnunet.preprocessing.preprocessing import GenericPreprocessor, PreprocessorFor2D
        if self.threeD:
