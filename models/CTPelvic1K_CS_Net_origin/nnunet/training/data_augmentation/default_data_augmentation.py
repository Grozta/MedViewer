...
from models.CTPelvic1K_CS_Net_origin.nnunet.training.data_augmentation.pyramid_augmentations import MoveSegAsOneHotToData, \
    RemoveRandomConnectedComponentFromOneHotEncodingTransform, ApplyRandomBinaryOperatorTransform, MoveLastFewDataToSeg_pbl
from models.CTPelvic1K_CS_Net_origin.nnunet.training.data_augmentation.custom_transforms import Convert3DTo2DTransform, Convert2DTo3DTransform, \
    MaskTransform
...
def get_default_augmentation(dataloader_train, dataloader_val, patch_size, params=default_3D_augmentation_params,
    ...
    if params.get("move_last_few_data_chanels_to_data"):
        val_transforms.append(MoveLastFewDataToSeg_pbl(params.get("last_few_data_channels"),'data', 'seg')) # [seg_gt, pre_seg, sdf]
