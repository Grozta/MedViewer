...
def restore_model(pkl_file, checkpoint=None, train=False):
    ...
    init = info['init']
    name = info['name']
    search_in = join(base_dir, 'models', 'CTPelvic1K_CS_Net', 'nnunet', "training", "network_training")
    # tr = recursive_find_trainer([search_in], name, current_module="models.CTPelvic1K_CS_Net.nnunet.training.network_training")
    tr = nnUNetTrainer
