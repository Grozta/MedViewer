import matplotlib
from models.CTPelvic1K_CS_Net.nnunet.training.network_training.network_trainer import NetworkTrainer
...
from models.CTPelvic1K_CS_Net.nnunet.training.dataloading.dataset_loading import load_dataset, DataLoader3D, DataLoader2D, unpack_dataset, DataLoader3D_oversampleJoint
from models.CTPelvic1K_CS_Net.nnunet.training.loss_functions.dice_loss import DC_and_CE_loss, DC_and_CE_Exclusion_loss, DC_and_CE_Exclusion_loss_DeepS
...
from models.CTPelvic1K_CS_Net.nnunet.training.data_augmentation.default_data_augmentation import default_3D_augmentation_params, \
...
from models.CTPelvic1K_CS_Net.nnunet.evaluation.metrics import ConfusionMatrix
from models.CTPelvic1K_CS_Net.nnunet.training.network_training.HSC82 import PGS_Net
...
class nnUNetTrainer(NetworkTrainer):
    ...
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
        ...
        IMPORTANT: If you inherit from models.CTPelvic1K_CS_Net.nnunetTrainer and the init args change then you need to redefine self.init_args
    ...
    def preprocess_patient(self, input_files):
        ...
        :return:
        """
        from models.CTPelvic1K_CS_Net.nnunet.preprocessing.preprocessing import GenericPreprocessor, PreprocessorFor2D
        if self.threeD:
