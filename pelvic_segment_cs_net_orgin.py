...
from models.CTPelvic1K_CS_Net_origin.nnunet.inference.predict import preprocess_multithreaded
from models.CTPelvic1K_CS_Net_origin.nnunet.inference.segmentation_export import save_segmentation_nifti_from_softmax
from models.CTPelvic1K_CS_Net_origin.nnunet.training.model_restore import load_model_and_checkpoint_files
from models.CTPelvic1K_CS_Net_origin.postprocessing import newsdf_post_processor
from models.CTPelvic1K_CS_Net_origin.utils import _sitk_Image_reader, _sitk_image_writer
from util import get_base_dir

base_dir = get_base_dir()


def pelvic_segment_cs_net_origin(img_path, do_cut=False, save_path=None):
    """
    用cs-net盆骨分割
    ...
    """
    model = os.path.join(base_dir, 'models/CTPelvic1K_CS_Net_origin/nnUNetTrainer__nnUNetPlans')
    # list_of_lists = []
    if img_path is None:
        return
    ...
    if save_path is None:
        cleaned_output_files = [os.path.join(base_dir, 'predict_label/pelvic_CS_Net_origin',
    ...
    print('end of pelvic_segment_cs_net_origin')
...
if __name__ == '__main__':
    ...
    pelvic_segment_cs_net_origin(('img/pelvic/pelvic_img/dataset3_colon_025_data.nii.gz'), False, save_path=(label_file))