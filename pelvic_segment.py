...
from models.CTPelvic1K.nnunet.inference.predict import preprocess_multithreaded
from models.CTPelvic1K.nnunet.inference.segmentation_export import save_segmentation_nifti_from_softmax
from models.CTPelvic1K.nnunet.training.model_restore import load_model_and_checkpoint_files
from models.CTPelvic1K.postprocessing import newsdf_post_processor
from models.CTPelvic1K.utils import _sitk_Image_reader, _sitk_image_writer
from util import get_base_dir

base_dir = get_base_dir()


def pelvic_segment(img_path, do_cut=False, save_path=None):
    """
    用hdc-net盆骨分割
    ...
    """
    model = os.path.join(base_dir, 'models/CTPelvic1K/nnUNetTrainer__nnUNetPlans')
    # list_of_lists = []
    if img_path is None:
        return
    ...
    if save_path is None:
        cleaned_output_files = [os.path.join(base_dir, 'predict_label/pelvic',
...
if __name__ == '__main__':
    ...
    pelvic_segment(('img/pelvic/pelvic_img/dataset3_colon_025_data.nii.gz'), False, save_path=(label_file))
